package in.mansiz.dailyselfie.provider;
 ...
 * a full copypaste of Adam Porter's ContentProvider Lab
 * @author Manishgant
 *
 */
public class SelfieContentProvider extends ContentProvider {
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
        int rowsDeleted = mHelper.getWritableDatabase().delete(SelfieContract.SELFIE_TABLE_NAME,
                null,null);
        getContext().getContentResolver().notifyChange(
                SelfieContract.SELFIE_URI, null);
        return rowsDeleted;
	}
